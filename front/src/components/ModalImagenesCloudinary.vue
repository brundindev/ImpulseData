      ...
      <div class="image-selector-content">
        ...
        <div class="search-container">
          <div class="search-input-group">
            <input type="text" v-model="imageFilter" placeholder="Buscar imágenes..." @input="filterImages"
              class="search-input" />
            <!-- Sección de subida de archivos -->
            <div class="upload-section">
              <h4>Subir una nueva imagen</h4>
              <div class="file-upload-container">
                <input type="file" id="file-upload" @change="handleFileSelect" accept="image/*" ref="fileInput"
                  class="file-input" />
        ...
        <div v-else class="images-grid">
          <div v-for="image in paginatedImages" :key="image.publicId" class="image-item" @click="selectImage(image)">
            <div class="image-preview-container">
              <div v-if="imageLoading[image.publicId]" class="image-loading">
                <div class="loading-spinner small"></div>
              </div>
              <img :src="getCloudinaryUrl(image.publicId, { width: 120, height: 120 })" :alt="image.alt"
                class="image-preview" @error="handleImageLoadError" @load="handleImageLoad"
                :data-public-id="image.publicId" loading="lazy" />
            </div>
        ...
        <div v-if="totalPages > 1" class="pagination">
          <button @click="currentPage > 1 && (currentPage--)" :disabled="currentPage === 1" class="pagination-button">
            &laquo; Anterior
          </button>
